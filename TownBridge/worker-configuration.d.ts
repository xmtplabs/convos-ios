/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.jsonc` (hash: 29612a0e02f6eb8e0d2018996adb4030)
// Runtime types generated with workerd@1.20260815.1 2026-08-19 nodejs_compat
interface __BaseEnv_Env {
	RESULT_MAILBOX: DurableObjectNamespace<import("./src/index").ResultMailbox>;
	GROKBOT_SESSIONS: DurableObjectNamespace<import("./src/index").GrokBotSession>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ResultMailbox" | "GrokBotSession";
	}
