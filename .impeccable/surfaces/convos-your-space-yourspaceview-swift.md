...
- Direction: a quiet personal signal desk using Convos neutrals, dramatic editorial type, one inverted attention surface, a dismissible inverted bring-your-own-agent callout, and a visible bottom agent command bar between native More and chat controls. Useful-detail cards preserve message provenance; the optional agent widget links agent identity to its convo and private lane.
