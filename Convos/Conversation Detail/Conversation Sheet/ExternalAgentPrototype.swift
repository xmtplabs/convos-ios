...
enum ExternalAgentProvider: String, CaseIterable, Hashable, Identifiable {
    ...
    var shortDescription: String {
        ...
        case .grokBot: "Grok through the xAI API"
        }
    }
    ...
    var chatSubtitle: String {
        ...
        case .grokBot: "xAI connection demo · Scoped to this convo"
        }
    }
    ...
    var connectionTitle: String {
        ...
        case .grokBot: "Connect Grok through xAI"
        }
    }
    ...
    var connectionExplanation: String {
        ...
        case .grokBot:
            "This demo name represents a Convos agent powered by Grok. A real connection would use a scoped xAI API key on the server—not in the iPhone app."
        }
    }
    ...
    var requirements: [ExternalAgentConnectionRequirement] {
        ...
        case .grokBot:
            [
                .init(symbol: "key.fill", title: "xAI project key", detail: "Stored by the Convos connector service, never in the mobile client."),
                .init(symbol: "cpu", title: "Grok model access", detail: "The project must allow the selected model and response endpoint."),
    ...
    var welcomeMessage: String {
        ...
        case .grokBot: "GrokBot is connected as an xAI-powered demo agent. I’ll receive only the convo and Home context you explicitly allow."
        }
    }
}
