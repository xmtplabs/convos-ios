        ...
        VStack(alignment: .leading, spacing: DesignConstants.Spacing.stepX) {
            ...
            ForEach(Array(allMessages.enumerated()), id: \.element.base.id) { index, message in
                ...
                if !message.base.reactions.isEmpty {
                    ...
                    .padding(.leading, message.base.sender.isCurrentUser ? 0 : (isFullWidthAttachment ? DesignConstants.Spacing.step4x : avatarWidth + avatarSpacing + DesignConstants.Spacing.stepX))
