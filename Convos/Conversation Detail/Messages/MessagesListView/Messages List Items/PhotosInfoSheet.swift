...
struct PhotosInfoSheet: View {
    ...
    var body: some View {
        FeatureInfoSheet(
            ...
            paragraphs: [
                .init("When you send a pic, Convos removes its metadata, encrypts it, and deletes it from the network once it's delivered."),
                .init("Convos never asks to see your Camera Roll and never saves anything to your device."),
            ],
