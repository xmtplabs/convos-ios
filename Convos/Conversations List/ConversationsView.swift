...
struct ConversationsView: View {
    ...
    private var sidebarToolbar: some ToolbarContent {
        ...
        // Honk-style focus-mode prototype entry points. The production
        // compose/settings toolbar items moved to MainTabView.sharedTopBar;
        // these two stay here so the prototype remains reachable.
        ToolbarItem(placement: .bottomBar) {
            Button("Build assistant", systemImage: "hammer.fill") {
                viewModel.onStartAssistantBuilder()
            }
            .accessibilityLabel("Build a new assistant")
