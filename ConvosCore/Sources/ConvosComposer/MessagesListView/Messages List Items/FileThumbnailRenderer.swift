...
@MainActor
public final class FileThumbnailRenderer {
    public static let shared: FileThumbnailRenderer = FileThumbnailRenderer()

    public struct Result: Sendable {
        public let image: UIImage
        public let isContentThumbnail: Bool
    }
    ...
    public func cachedThumbnail(for attachmentKey: String) -> Result? {
    ...
    public func thumbnail(for attachmentKey: String, fileURL: URL) async -> Result? {
