...
EOF
...
elif [ "$TARGET_NAME" = "Convos" ] && [ "$CONFIGURATION" = "Testnet" ]; then
    ...
    # Generate Secrets.swift for Testnet
    cat > "$SECRETS_FILE" << EOF
import Foundation

// WARNING:
// This code is generated by the build phase for Testnet development.
// Do not edit this file directly. Your changes will be lost on next build.
// Git does not track this file.

// swiftlint:disable all

/// Secrets are generated automatically for Testnet development
enum Secrets {
    static let CONVOS_API_BASE_URL = "$CONVOS_API_BASE_URL"
    static let XMTP_CUSTOM_HOST = ""
    static let GATEWAY_URL = ""
