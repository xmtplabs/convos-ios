...
7. **05-reactions** — tests reactions (needs messages to react to)
8. **06-replies** — tests replies (needs messages to reply to)
9. **07-profile-update** — tests profile changes
10. **08-lock-conversation** — tests locking
